...
const translations: Record<string, any> = {
  en: {
    ...
    sectionSubtitle: "Get a free cost estimate and custom medical plan from India's premium JCI-accredited hospitals.",
    ...
    successMsg: "Thank you! Your enquiry has been received. One of our senior medical coordinators will contact you within 24 hours.",
    validation: {
  ...
  kk: {
    ...
    sectionSubtitle: "Үндістанның JCI аккредиттелген үздік ауруханаларынан тегін құн есебін және жеке емдеу жоспарын алыңыз.",
    ...
    successMsg: "Рақмет! Сіздің сұранысыңыз қабылданды. Біздің аға медициналық үйлестірушіміз сізбен 24 сағат ішінде байланысады.",
    validation: {
  ...
  uz: {
    ...
    sectionSubtitle: "Hindistonning eng yaxshi JCI-akkreditatsiyalangan shifoxonalaridan bepul narx smetasi va shaxsiy tibbiy rejasini oling.",
    ...
    successMsg: "Rahmat! So'rovingiz qabul qilindi. Bizning katta tibbiy koordinatorimiz siz bilan 24 soat ichida bog'lanadi.",
    validation: {
  ...
  ru: {
    ...
    sectionSubtitle: "Получите бесплатную оценку стоимости и индивидуальный медицинский план от ведущих аккредитованных больниц Индии.",
    ...
    successMsg: "Спасибо! Ваш запрос успешно получен. Один из наших ведущих медицинских координаторов свяжется с вами в течение 24 часов.",
    validation: {
...
export default function EnquirySection() {
  ...
  return (
    <section className="relative w-full py-16 lg:py-24 bg-[#FAF9F9] overflow-hidden" aria-label="Enquiry Section">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-[48%] flex flex-col items-start text-left">
            <span className="font-montserrat font-bold text-[14px] lg:text-[16px] text-[#EE4423] tracking-[2px] uppercase mb-4">
              {locale === 'en' ? "Instant Consultation" : locale === 'kk' ? "Шұғыл кеңес" : locale === 'uz' ? "Tezkor maslahat" : "Быстрая консультация"}
            </span>
            ...
            <div className="w-full bg-white rounded-[32px] shadow-[10px_20px_40px_rgba(0,0,0,0.04)] border border-gray-100 p-8 relative overflow-hidden">
              ...
              {isSuccess ? (
                ...
                <div className="flex flex-col items-center justify-center text-center py-10 animate-in fade-in duration-300">
                  ...
                  >
                    {locale === 'en' ? "Submit Another Enquiry" : locale === 'kk' ? "Басқа сұраныс жіберу" : locale === 'uz' ? "Yana so'rov yuborish" : "Отправить еще один запрос"}
                  </button>
                </div>
              ) : (
