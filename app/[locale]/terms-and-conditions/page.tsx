...
const SectionIcon = ({ type }: { type: string }) => {
  switch (type) {
    case 'acceptance': return <FileText className="w-6 h-6 text-[#EE4423]" />;
    case 'services': return <Activity className="w-6 h-6 text-[#EE4423]" />;
    case 'disclaimer': return <AlertCircle className="w-6 h-6 text-[#EE4423]" />;
    case 'responsibilities': return <UserCheck className="w-6 h-6 text-[#EE4423]" />;
    case 'payments': return <CreditCard className="w-6 h-6 text-[#EE4423]" />;
    case 'accuracy': return <CheckCircle className="w-6 h-6 text-[#EE4423]" />;
    case 'liability': return <Scale className="w-6 h-6 text-[#EE4423]" />;
    case 'intellectual': return <Copyright className="w-6 h-6 text-[#EE4423]" />;
    case 'governing': return <Gavel className="w-6 h-6 text-[#EE4423]" />;
...
export default async function TermsConditionsPage({
  ...
  const sections = [
    'acceptance', 'services', 'disclaimer', 'responsibilities', 
    'payments', 'accuracy', 'liability', 'intellectual', 
    'governing', 'contact'
  ];
